...
import cars from '../../assets/images/cars/mercedes-2.webp';
import car from '../../assets/images/cars/home.webp';
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-4">
          ...
          <div className="w-full lg:w-1/2 backdrop-blur-lg bg-white/20 text-white flex flex-col justify-center p-8 shadow-lg">
            <h2 className="text-3xl font-bold mb-4 text-center">
              Best Deals at Our <span className="text-blue-500">Cars Shop</span>
            </h2>
            ...
            <Link to="/cars">
              <button className="bg-blue-600 text-white py-2 px-6 mt-4 hover:bg-gray-300 transition duration-300">
